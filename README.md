...
- Ручное закрытие месяца («Начать новый месяц» за 2 дня до конца) и вкладка «История»
- Мультивалютность RSD / EUR / USD / GEL
- Быстрая запись расходов через Telegram-бот
- Ежедневные пользовательские напоминания в Telegram (раздел «Напоминания»)
- Cron: авто-списание, курсы, отправка напоминаний
